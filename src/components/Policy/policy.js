  ...
  return (
    <main>
      ...
      <ul className={classes.ul}>
        <li>
        Over 40 million quiz enthusiasts have played with us
        </li>
        <li>We are India's favorite Quiz destination</li>
        <li>We are India's favorite Quiz destination</li>
        <li>We offer quizzes in over 25 categories like GK, sports,
bollywood, geography, business, histony, IPL & more</li>
